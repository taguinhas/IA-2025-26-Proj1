...
from game.piece import Piece, Owner, Size, Shape
...
class Game:
    ...
    def populate_board(self):
        ...
        for x, shape in enumerate(shapes):
            #Big white pieces
            self.board.place_piece(Piece(Owner.WHITE, shape, Size.BIG),x, 5)

            #Small white pieces
            self.board.place_piece(Piece(Owner.WHITE, shape, Size.SMALL),x, 4)

            #Big black pieces
            self.board.place_piece(Piece(Owner.BLACK, shape, Size.BIG),x, 0)

            #Small black pieces
            self.board.place_piece(Piece(Owner.BLACK, shape, Size.SMALL),x, 1)
